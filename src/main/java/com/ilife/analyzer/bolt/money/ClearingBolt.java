            ...
            for (List<Column> row : result) {
               ...
               if("team".equalsIgnoreCase(beneficiaryType)) { //beneficiaryType==team
				...
				String sqlUpdate = "insert into mod_clearing(id,platform,order_id,order_time,item,amount_order,amount_commission,amount_profit,scheme_id,scheme_item_id,beneficiary,beneficiary_type,share,status_clear,create_date,update_date) "
						+ "values('__id','_platform','_order_id','_order_time','__item','_amount_order','_amount_commission','_amount_profit','_scheme_id','_scheme_item_id','__beneficiary','_beneficiary_type','_share','_status',now(),now())"
