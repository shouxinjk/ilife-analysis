...
import com.ilife.analyzer.bolt.person.DynamicEvaluateBolt;
import com.ilife.analyzer.spout.person.EvaluateMeasureSpout;
...
public class EvaluateByMeasure extends AbstractTopology {
	    ...
	    public StormTopology getTopology() {
            ...
            String nodeSpout = "evaluate_user_measure_spout";
            String nodeCalcBolt = "evaluate_user_measure_clac_bolt";
