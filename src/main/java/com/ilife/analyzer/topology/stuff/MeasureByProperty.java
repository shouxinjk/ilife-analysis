...
public class MeasureByProperty extends AbstractTopology {
	    ...
	    public StormTopology getTopology() {
            ...
            String sql = "select sum(mp.weight*p.score) as score, ? as itemKey, ? as dimension from measure m,measureproperty mp,property p where m.itemKey=? and m.dimension=? and mp.dimension=m.dimension and mp.measure=p.id";
