...
import com.ilife.analyzer.bolt.stuff.DynamicMeasureBolt;
...
public class MeasureByDimension extends AbstractTopology {
    ...
    public StormTopology getTopology() {
        ...
        String sql = "select sum(weight*score) as score, ? as itemKey, ? as dimension,featured from measure where itemKey=? and parent=?";
        ...
        String[] output_fields = {"score","itemKey","dimension","featured"};
        ...
        //3.2，同步featured维度到arangodb
        DynamicMeasureBolt dynamicMeasureBolt = new DynamicMeasureBolt(props,database,collection,businessConnectionProvider,analyzeConnectionProvider);
